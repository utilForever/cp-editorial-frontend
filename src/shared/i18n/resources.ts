  ...
  en: {
    translation: {
      ...
      categories: {
        ...
        description:
          'Top-level categories collect related contest families. Use category and contest examples to choose where to continue browsing.',
        uncategorized: 'Uncategorized',
        empty: 'No categories are available yet.',
        count_one: '{{count}} editorial',
        count_other: '{{count}} editorials',
        summary: {
          withPaths_one: 'Includes {{count}} representative child category.',
          withPaths_other: 'Includes {{count}} representative child categories.',
  ...
  ko: {
    translation: {
      ...
      categories: {
        heading: '카테고리별 보기',
        description:
          '최상위 카테고리는 관련 대회 계열을 묶습니다. 카테고리와 대회 예시를 보고 다음 탐색 위치를 고르세요.',
        uncategorized: '미분류',
        empty: '등록된 카테고리가 없습니다.',
        count_one: '{{count}}개 에디토리얼',
        count_other: '{{count}}개 에디토리얼',
        summary: {
          withPaths_one: '대표 하위 카테고리 {{count}}개를 포함합니다.',
          withPaths_other: '대표 하위 카테고리 {{count}}개를 포함합니다.',
          direct: '이 카테고리 바로 아래의 대회를 보여줍니다.',
        },
        categoryExamples: '카테고리 예시',
  ...
  ja: {
    translation: {
      ...
      categories: {
        heading: 'カテゴリ別に見る',
        description:
          'トップレベルカテゴリは関連する大会群をまとめます。カテゴリと大会例を見ながら、次に進む場所を選べます。',
        uncategorized: '未分類',
        empty: 'カテゴリはまだありません。',
        count_one: '{{count}} 件のエディトリアル',
        count_other: '{{count}} 件のエディトリアル',
        summary: {
          withPaths_one: '{{count}} 件の代表的な子カテゴリがあります。',
          withPaths_other: '{{count}} 件の代表的な子カテゴリがあります。',
          direct: 'このカテゴリ直下の大会を表示します。',
        },
        categoryExamples: 'カテゴリ例',
        contestExamples: '大会例',
        browse: '閲覧',
        search: 'このカテゴリを検索',
      },
